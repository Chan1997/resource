/**
 * Created by Vikash Mehta on 13/1/16.
 */
/*!
 * ngTagsInput v3.0.0
...
(function() {
    ...
    tagsInput.run(["$templateCache", function($templateCache) {
        ...
        $templateCache.put('ngTagsInput/tag-item.html',
            "<div style='display:inline-block; width:calc(100% - 15px)' class='div-overflow' ng-bind=\"$getDisplayText()\"></div><div style='display:inline-block; vertical-align: top; width:15px'><a class=\"remove-button\" ng-click=\"$removeTag()\" ng-bind=\"::$$removeTagSymbol\"></a></div>"
        );
